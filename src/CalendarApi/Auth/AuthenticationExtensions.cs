...
namespace CalendarApi.Auth;

/// <summary>
/// Wires Calendar's dual authentication (BFF cookie for the browser + JWT bearer for machine
...
public static class AuthenticationExtensions
{
    ...
    private static async Task UpsertLocalUserAsync(Microsoft.AspNetCore.Authentication.OpenIdConnect.TokenValidatedContext ctx)
    {
        ...
        var db = ctx.HttpContext.RequestServices.GetRequiredService<CalendarDbContext>();
    ...
    public static void AddCalendarAuth(this WebApplicationBuilder builder)
    {
        ...
        authBuilder.AddCookie(options =>
            {
                options.Cookie.Name = "calendar.auth";
        ...
        if (bffEnabled)
        {
            authBuilder.AddOpenIdConnect(options =>
            {
                ...
                // (auth.calendar.localhost) are different hosts behind the proxy. The callback is a
                ...
                // RFC 8707 resource indicator → Logto mints a JWT access token for the Calendar API.
